...
<div class="content-wrapper">
    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="forms-sample" method="POST" action="{{ url('banner/update') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="title">Title<span class="text-red">*</span></label>
                                <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{$banner->title}}" placeholder="Enter Title">
                     ...
                     <div class="col-sm-6">
                        <div class="form-group">
                            <label for="url">URL<span class="text-red">*</span></label>
                                <input id="url" type="text" class="form-control @error('title') is-invalid @enderror" name="url" value="{{$banner->url}}" placeholder="Enter URL">
                                <div class="help-block with-errors" ></div>
                                @error('url')
                        ...
                        <div class="form-group">
                            <!--<label for="status">Status<span class="text-red">*</span></label>-->
                                <div class="form-check form-switch">
                                  <input class="form-check-input" name="status" type="checkbox" id="flexSwitchCheckDefault" value="1" {{  ($banner->status == 1 ? ' checked' : '') }}>
