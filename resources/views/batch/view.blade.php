        ...
        <div class="row align-items-end">
            <div class="col-lg-12">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h3 class=" rv-list-users">Batch List</h3>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="card p-3 m-3-rv">
                <div class="card-header">
                    <a href="{{url('batch/create')}}" class="btn btn-primary2">Add +</a>
                   </div>
                <div class="card-body">
                        ...
                        <tbody>
                          @foreach($batch as $batchs)
                            <tr>
                                ...
                                <td>{{$batchs->department_id}}</td>
                                <td>
                                    <a href="batch/edit/{{$batchs->id}}"><i class="fa fa-edit text-green"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="batch/delete/{{$batchs->id}}" class="delete-confirm"><i class="fa fa-trash text-red"></i></a>
                                </td>
                            </tr>
                          @endforeach
                        </tbody>
