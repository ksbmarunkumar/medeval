...
.form-control:focus
{
    border: 1px solid #42e523 !important;
}
</style>
...
<div class="content-wrapper">
    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="forms-sample" method="POST" action="{{ url('branch/update') }}" enctype="multipart/form-data">
                @csrf
                    <input type="hidden" name="id" value="{{$branch->id}}">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="branch_name">Branch<span class="text-red">*</span></label>
                                <input id="branch_name" type="text" class="form-control @error('branch_name') is-invalid @enderror" name="branch_name" value="{{$branch->branch_name}}" placeholder="Enter branch">
                                <div class="help-block with-errors" ></div>
                                @error('branch_name')
                                    <span class="invalid-branch_name" role="alert">
                        ...
                        <div class="form-group">
                            <!--<label for="status">Status<span class="text-red">*</span></label>-->
                                <div class="form-check form-switch">
                                  <input class="form-check-input" name="status" type="checkbox" id="flexSwitchCheckDefault" value="1" {{  ($branch->status == 1 ? ' checked' : '') }}>
