...
<div class="content-wrapper">
    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="forms-sample" method="POST" action="{{ url('faq/update') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="question">Question<span class="text-red">*</span></label>
                                <input id="question" type="text" class="form-control @error('question') is-invalid @enderror" name="question" value="{{$faq->question}}" placeholder="Enter Question">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="answer">Answer<span class="text-red">*</span></label>
                                <input id="answer" type="text" class="form-control @error('answer') is-invalid @enderror" name="answer" value="{{$faq->answer}}" placeholder="Enter Answer">
                                <div class="help-block with-errors" ></div>
                                @error('answer')
