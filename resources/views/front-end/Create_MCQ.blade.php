                        ...
                        <div class="events__meta">
                           ...
                           <form id="regForm">
                                  ...
                                  <div class="form-outline">
                                     <label class="form-label" for="formControlSm">Answer 1</label>
                                     <input type="text" id="formControlSm" placeholder="Enter Answer 1..."
                                        class="form-control form-control-sm" />
    
                                  </div>
                                  <div class="form-outline">
                                     <label class="form-label" for="formControlSm">Answer 2</label>
                                     <input type="text" id="formControlSm" placeholder="Enter Answer 2..."
                                        class="form-control form-control-sm" />
    
                                  </div>
                                  <div class="form-outline">
                                     <label class="form-label" for="formControlSm">Answer 3</label>
                                     <input type="text" id="formControlSm" placeholder="Enter Answer 3..."
                                        class="form-control form-control-sm" />
    
                                  </div>
                                  <div class="form-outline">
                                     <label class="form-label" for="formControlSm">Answer 4</label>
                                     <input type="text" id="formControlSm" placeholder="Enter Answer 4..."
                                        class="form-control form-control-sm" />
    
                                  </div>
                                  <div class="form-outline">
                                     <label class="form-label" for="formControlSm">Right Answer</label>
                                  ...
                                  <div class="form-outline">
                                     <label class="form-label" for="formControlSm">Right Answer</label>
                                     <select class="form-select form-select-lg mb-3 valid" aria-label=".form-select-lg example">
                                        <option selected>Select...</option>
                                        <option value="1">Answer 1</option>
                                        <option value="2">Answer 2</option>
                                        <option value="3">Answer 3</option>
                                  ...
                                  <div class="col-12 d-flex">
                                     ...
                                     <a href="{{url('/MCQ_test')}}" class="e-btn">Previous</a>
                                  </div>
