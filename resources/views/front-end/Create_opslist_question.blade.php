                        ...
                        <div class="events__meta">
                           ...
                           <form id="regForm">
                              ...
                              <div class="form-group">
                                ...
                                <input type="number"  placeholder="Enter No. of steps (50 Maximum)" id="SelName"
                                    class="form-control form-control123" min="0" max="15" onKeyPress="if(this.value.length==2) return false;" />
                              </div>
                              ...
                              <div class="form-outline">
                                ...
                                <input type="text" id="formControlDefault" placeholder="Enter Total Marks number..."
                                   class="form-control" />
                             ...
                             <div class="tab">
                              ...
                              <div class="col-12 d-flex">
                                     ...
                                     <a href="{{url('/create_opslist')}}" class="e-btn">Previous</a>
                                  </div>
...
$(".form-control123").on("change", function(){
var inputVal = $(".form-control123").val();
$(".sub-cats").html("");
for (i = 1; i <= inputVal; i++){
 $(".sub-cats").append('<div class="col-12 form-group" id="image' + i +'"><label>Answer '+i+':*</label><input type="number" placeholder="Enter Answer '+i+'..." class="form-control"></div>');
