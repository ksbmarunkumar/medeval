    ...
    <section class="events__area pt-115 pb-120 p-relative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xxl-4 offset-xxl-4">
                    <div class="section__title-wrapper mb-60 text-center">
                        <h2 class="section__title">Assign <span class="yellow-bg yellow-bg-big"><img
                                    src="{{ asset('assets/img/shape/yellow-bg.png') }}" alt="">Test</span></h2>
                    ...
                    <div class="header__search p-relative ml-50 d-none d-md-block">
                        <form action="#">
                            ...
                            <input type="date" placeholder="Search..."
                                style="width:190px; padding: 25px 20px 20px 20px;">
            ...
            <div class="row">
                ...
                @foreach ($tests as $t)
               <?php 
               if(Auth::user()->teacher_id == $t->teacher_id){
                 ?>  
                    ...
                    <div class="events__item mb-10 hover__active">
                        <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                            ...
                            <div class="events__content">
                                ...
                                <h3 class="events__title">{{ $t->test_name }}</h3>
                                <div class="events__meta">
                                    <table>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><span> {{ $t->test_name }}</span></td>
                                            </tr>
                                            <tr>
                                                <td><span>Total Marks</span>
                                                </td>
                                                <td style="width:20px;text-align: center;">:</td>
                                                <td><span> {{ $t->marks }}</span></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div class="header__btn view__btn-2 ml-50 d-none d-sm-block footer_b">
                                        <a href="#" class="btn12" data-toggle="modal"
                                            data-target="#myModal"  onclick="myTest_id({{$t->id}})">Asing test </a>
                                        <a href="{{ url('/assign_modules', $t->id) }}" class="btn12">Assing modules</a>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="verticals">
                                ...
                                <a href="{{ url('/assign_studnet', $t->id) }}" class="btn12"
                                    data-toggle="modal">Assign Student
                                </a>
                                <a href="{{ url('/assign_teacher', $t->id) }}" class="btn12">Assign Teacher</a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                                <form action="{{ route('assign_test_check_box') }}" method="post" enctype="multipart/form-data" id="assign_test_check_box">
                                    @csrf
                                    <input type='hidden' name="test_id" id="test_id">
                                    <input type="radio" name="group1" value="assign_teacher" id="assign_teacher"
                                        ><label for="rad1">Teacher</label>
                                    <input type="radio" name="group1" value="assign_studnet" id="assign_studnet"
                                        ><label for="rad1">Student</label>
                                    <br>
                                  
                                    <button type="submit" class="btn btn-default popup_btn"
