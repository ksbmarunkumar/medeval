        ...
        <div class="container">
            <div class="row">
                <h2 class="section__title" style="text-align:center; margin-bottom: 30px;">Create
                    <span class="yellow-bg yellow-bg-big"><img src="assets/img/shape/yellow-bg.png" alt="">TEST</span>
                </h2>
                                                        ...
                                                        <div class="events__item-inner  align-items-center justify-content-between white-bg">
                                                            <div class="events__content  ">
                                                                ...
                                                                <div class="events__meta">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td style="width:20px;text-align: center;">
                                                                                    :</td>
                                                                                <td><span> 2022-11-25 09:47:27</span>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td><span>Subject</span>
                                                                    ...
                                                                    <a href="#"><button type="button" class="btn btn-warning"><i class="fa fa-eye" aria-hidden="true"></i>
                                                                            View</button></a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="events__item-inner  align-items-center justify-content-between white-bg">
                                                            <div class="events__content  ">
                                                                ...
                                                                <div class="events__meta">
                                                                    <table>
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td style="width:20px;text-align: center;">
                                                                                    :</td>
                                                                                <td><span> 2022-11-25 05:16:18</span>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td><span>Subject</span>
                                                                    ...
                                                                    <a href="{{ url('/Short_View_details/1') }}"><button type="button" class="btn btn-warning"><i class="fa fa-eye" aria-hidden="true"></i>
                                                                            View</button></a>
                                                                    ...
                                                                    <table>
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td style="width:20px;text-align: center;">
                                                                                    :</td>
                                                                                <td><span> 2022-11-25 12:29:56</span>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td><span>Subject</span>
                                                        ...
                                                        <div class="events__item-inner  align-items-center justify-content-between white-bg">
                                                            <div class="events__content  ">
                                                                ...
                                                                <div class="events__meta">
                                                                    ...
                                                                    <a href="{{ url('/Opslist_View_details/1') }}"><button type="button" class="btn btn-warning"><i class="fa fa-eye" aria-hidden="true"></i>
                                                                            View</button></a>
