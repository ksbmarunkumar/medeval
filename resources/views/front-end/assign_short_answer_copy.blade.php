...
@section('main_section')
    <section class="events__area pt-115 pb-120 p-relative">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter test name" value="{{ $shortQue->test_name }}"
        ...
        //                             $page_name = "assign_short_ans";

        //                             if($page_name == "assign_short_ans"){
        ...
        //                              ->where('assign_modules.assigner_id','=',Auth::id())
        //                              ->get()->toArray();
        //                             }
        ...
        //      array_push($stusent_table_data_array,$stusent_table_data);
        //     //  print_r($stusent_table_data_array);
        //      }
        //      $students_diff_array = array_diff($stusent_table_data_array, $module_array_stu);
        //     //  print_r($students_diff_array);           
        ...
        //    }
                                     ...
                                     ->where('assign_modules.shortQue_id','=',$sQueId)
                                    ...
                                    // for short_que_tests test_name
                                     ...
                                     $shortQue_id = DB::table('short_que_tests')
                                     ->select('short_que_tests.test_name')
                                     ->where('short_que_tests.id','=',$data_get->shortQue_id)
                                     ->get();
                                     
                                     $shortQue_id_name = json_decode($shortQue_id);
                                     $shortQue_name = $shortQue_id_name[0]->test_name;
