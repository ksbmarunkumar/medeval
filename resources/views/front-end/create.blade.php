               ...
               <div class="row">
                  <div class="col-xxl-4 offset-xxl-4">
                     <div class="section__title-wrapper mb-60 text-center">
                        <h2 class="section__title">Create <span class="yellow-bg yellow-bg-big">Test<img src="assets/img/shape/yellow-bg.png" alt=""></span></h2>
                     ...
                     <div class="events__item mb-10 hover__active">
                        <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                           <div class="events__content">
                              ...
                              <h3 class="events__title">1.Digital transformation conference</h3>
							   <div class="events__meta">
                                 <span>Test Date : Jun 14, 2022</span>
								 <br>
                            
                                 <span>No of Question : 50</span>
								 <br>
								 
								 <span>Duration : 50</span>
								 <br>
								 
								 <span>Total Marks : 50</span>
								 
								 <div class="header__btn view__btn-2 ml-50 d-none d-sm-block" style="margin-left: 17px;">
								   <a href="#" class="e-btn" data-toggle="modal" data-target="#myModal">Create</a>
								</div>
                              </div>
                           </div>
