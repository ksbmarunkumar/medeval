         ...
         <div class="row">
            <div class="col-xxl-4 offset-xxl-4">
               <div class="section__title-wrapper mb-60 text-center">
                  <h2 class="section__title">Create <span class="yellow-bg yellow-bg-big">Osplist<img
                ...
                <span class="background-design"></span>
                  <div class="events__item-inner  align-items-center justify-content-between white-bg">
                     ...
                     <div class="events__content  ">
                        ...
                        <h3 class="events__title">Create Form </h3>
                        ...
                        <div class="events__meta">
                            ...
                            <div class="form-outline">
                                <label class="form-label" for="formControlLg">Test Name</label>
                                <input type="text" id="formControlLg" placeholder="Enter Test Name..." class="form-control form-control-lg" />
                                
                              </div>
                              
                              <div class="form-outline">
                                <label class="form-label" for="formControlDefault">Subject Name</label>
                                <input type="text" id="formControlDefault" placeholder="Enter Subject Name..." class="form-control" />
                                
                              </div>
                              
                              <div class="form-outline">
                                <label class="form-label" for="formControlSm">Marks</label>
                                <input type="text" id="formControlSm" placeholder="Enter Marks..." class="form-control form-control-sm" />
                                
                              </div>
                              <div class="form-outline">
                                <label class="form-label" for="formControlSm">Duration</label>
                                <input type="text" id="formControlSm" placeholder="Enter Duration..." class="form-control form-control-sm" />
                                
                              </div>
                              <div class="form-outline">
                                <label class="form-label" for="formControlSm">No. of Question</label>
                                <input type="text" id="formControlSm" placeholder="Enter No. of Question..." class="form-control form-control-sm" />
                                
                              </div>
                              <div class="form-outline">
                                <label class="form-label" for="formControlSm">Branch</label>
                           ...
                           <div class="header__btn view__btn-2 mt-4 text-center">
                              <a href="{{url('/Create_opslist_question')}}" class="e-btn" >Create</a>
                           </div>
                        </form>
                        </div>
                     </div>
