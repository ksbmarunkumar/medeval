         ...
         <div class="row">
            <div class="col-xxl-4 offset-xxl-4">
               <div class="section__title-wrapper mb-60 text-center">
                  <h2 class="section__title">Create <span class="yellow-bg yellow-bg-big">Short Answer<img
                        ...
                        <div class="events__meta">
                            ...
                            <div class="form-outline">
                              ...
                              <div class="form-outline">
                                ...
                                <input type="text" id="formControlSm" placeholder="No. of Question..." class="form-control form-control-sm" />
                           ...
                           <div class="header__btn view__btn-2 mt-4 text-center">
                              <a href="{{url('/Create_short_question')}}" class="e-btn" >Create</a>
                           </div>
                        </form>
                        </div>
                     </div>
