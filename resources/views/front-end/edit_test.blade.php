...
<body>
    ...
    <section class="events__area pt-115 pb-120 p-relative">
        ...
        <div class="container">
            <div class="row">
                <h2 class="section__title" style="text-align:center; margin-bottom: 30px;">Update
                    <span class="yellow-bg yellow-bg-big"><img src="assets/img/shape/yellow-bg.png"
                            alt="">TEST</span>
                </h2>
                <form method="POST" action="{{ route('test_update', $test->id) }}" enctype="multipart/form-data"
                    id="form_area">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                class="form-control" name="marks" value="{{$test->marks}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter duration" readonly id="total_duration"
                                    class="form-control" value="0" name="duration">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="date">Date</label>
                                <input type="datetime-local" class="form-control" value="{{ $test->date }}" name="date">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select form-select-normal mb-3"
                                    ...
                                    @foreach ($branches as $b)
                                        <option value="{{ $b->id }}"
                                            @if ($b->id == $branch->id) {{ 'selected' }} @endif>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-select form-select-normal mb-3"
                                    aria-label=".form-select-normal example" name="main_subject_id">
                                    @foreach ($subjects as $s)
                                        <option value="{{ $s->id }}"
                                            @if ($s->id == $subject->id) {{ 'selected' }} @endif>
                                            {{ $s->subject }}</option>
                                    @endforeach
                                </select>
                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    id="test-name" value="{{$test->viva_name}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                        ...
                        <br>
                        <button type="submit" id="submitBtn" class="btn btn-primary e-btn">UPDATE TEST</button>
                </form>
            </div>
        </div>
    </section>
    ...
    <script>
        $(document).ready(() => {
            $.ajax({
                type: "GET",
                url: "{{ route('test_edit', $test->id) }}",

                success: function(data) {
                    console.log(data)

                    data.osp_test.forEach(ospObj => {
                        let obj = composeQueObj(ospObj.ospt_id, ospObj.test_name, parseInt(
                            ospObj.duration), parseInt(ospObj.marks))
                        ospQueObjSet.add(JSON.stringify(obj))
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="events__content  ">
                                                            ...
                                                            <div class="events__meta">
                                                                ...
                                                                <button  type="button"  onclick='addOspQuestoArray(${ospObj.ospt_id} , "${ospObj.test_name}" , "${ospObj.duration}", ${ospObj.marks})'   class="btn btn-warning">  <i class="fa fa-plus" aria-hidden="true"></i> Add</button> 
                        ...
                        let htmlIds =
                            `<input type='hidden' id='osp_id-${ospObj.ospt_id}' readonly class='mcq_test_id' name='osp_id[]' value='${ospObj.ospt_id}'/>`
                        $(`#osp_id_container`).append(htmlIds)
                        console.log(ospObj)
                    });

                    setUpSelect2(ospQueObjSet, 'OsplistIDMK')
                    $("#OsplistIDMK").select2('open')


                    data.mcq_test.forEach(mcqObj => {
                        let obj = composeQueObj(mcqObj.mcqt_id, mcqObj.test_name, parseInt(
                            mcqObj.duration), parseInt(mcqObj.marks))
                        mcqQueObjSet.add(JSON.stringify(obj))
                        let html = `<div class="events__item hover__active">
                                                                <div
                                                                    class="events__item-inner  align-items-center justify-content-between white-bg">
                                                                            ...
                                                                            <a
                                                                                href="{{ url('/Opslist_View_details/1') }}"><button
                                                                                    ...
                                                                                    class="btn btn-warning"><i
                                                                                        ...
                                                                                        aria-hidden="true"></i>
                                                                                    View</button></a>
                                                                         <button  type="button"  onclick='addMcqQuestoArray(${mcqObj.mcqt_id} , "${mcqObj.test_name}" , "${mcqObj.duration}", ${mcqObj.marks} )'   class="btn btn-warning">  <i class="fa fa-plus" aria-hidden="true"></i> Add</button> 
                                                                        </div>
                                                                    </div>
                        ...
                        let htmlIds =
                            `<input type='hidden' id='mcq_id-${mcqObj.mcqt_id}' readonly class='mcq_test_id' name='mcq_id[]' value='${mcqObj.mcqt_id}'/>`
                        $(`#mcq_id_container`).append(htmlIds)
                    });

                    setUpSelect2(mcqQueObjSet, 'mcqIDMK')
                    $("#mcqIDMK").select2('open')


                    data.shortAns_test.forEach(sObj => {
                        let obj = composeQueObj(sObj.shortt_id, sObj.test_name, parseInt(sObj
                            .duration), parseInt(sObj.marks))
                        shortQueObjSet.add(JSON.stringify(obj))
                        let html = `<div class="events__item mb-10 hover__active">
                                                    <div
                                                        class="events__item-inner  align-items-center justify-content-between white-bg">
                                                                ...
                                                                <a
                                                                    href="{{ url('/Opslist_View_details/1') }}"><button
                                                                        ...
                                                                        class="btn btn-warning"><i
                                                                            ...
                                                                            aria-hidden="true"></i>
                                                                        View</button></a>
                                                                        <button  type="button"  onclick='addShortQuestoArray(${sObj.shortt_id} , "${sObj.test_name}", "${sObj.duration}", ${sObj.marks})'   class="btn btn-warning">  <i class="fa fa-plus" aria-hidden="true"></i> Add</button> 
                        ...
                        let htmlIds =
                            `<input type='hidden' id='short_id-${sObj.shortt_id}' readonly class='mcq_test_id' name='short_id[]' value='${sObj.shortt_id}'/>`
                        $(`#short_id_container`).append(htmlIds)
                    });
                    setUpSelect2(shortQueObjSet, 'shortansID')
                    $("#shortansID").select2('open')
                    console.log(data)
                },
                error: function(data) {
                    $("#osp_results_container").empty()
