            ...
            <div class="container">
               <div class="row">
                  <div class="col-xxl-4 offset-xxl-4">
                     <div class="section__title-wrapper mb-60 text-center">
                        <h2 class="section__title">Batch <span class="yellow-bg yellow-bg-big"><img src="assets/img/shape/yellow-bg.png" alt=""></span></h2>
			   ...
			   <div class="col-xxl-10 offset-xxl-1 col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
					 <div class="events__meta">
                                 ...
                                 <span style="color:#000"><b>Session Id :</b> 123458795</span>
								 <br>
								 <span style="color:#000"><b>Password :</b> xyzabc</span>
                  ...
                  <div class="col-xxl-10 offset-xxl-1 col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
                     <div class="events__item mb-10 hover__active">
                        <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                              ...
                              <img src="assets/img/student-profile.png" alt="logo" id="student-profile" style="width:80px;"><span class="events__title"> Rohan Singh</span>
							   <a href="#"><span class="events__title view">View</span></a>
                           </div>
							   
							   
                        
                           <div class="events__more">
                               <p id="student_count">Roll No</p><span id="student_count2">10</span>
				  ...
				  <div class="col-xxl-10 offset-xxl-1 col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
                     <div class="events__item mb-10 hover__active">
                        <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                           ...
                           <div class="events__more">
                               <p id="student_count">Roll No</p><span id="student_count2">20</span>
				  ...
				  <div class="col-xxl-10 offset-xxl-1 col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
                     <div class="events__item mb-10 hover__active">
                        <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                           ...
                           <div class="events__more">
                               <p id="student_count">Roll No</p><span id="student_count2">30</span>
				  ...
				  <div class="col-xxl-10 offset-xxl-1 col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
                     <div class="events__item mb-10 hover__active">
                        <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                           ...
                           <div class="events__more">
                               <p id="student_count">Roll No</p><span id="student_count2">40</span>
