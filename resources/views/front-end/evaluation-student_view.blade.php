               ...
               <div class="row">
                  <div class="col-xxl-10 offset-xxl-1 col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
						  <div class="events__content event_b">
                              <h3 class="events__title answer_details">Q1.Digital transformation conference</h3>
							   <div class="events__meta">
                  
                                 <span class="answer_details2"><b>Ans :</b> Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
							   ...
							   <h3>Range here</h3>
							  <a href="login.html" class="e-btn">Next 2/10</a>
                           </div>
                     </div>
                  </div>
