...
<body>
            ...
            <div class="row">
                <div class="col-xxl-4 offset-xxl-4">
                    <div class="section__title-wrapper mb-60 text-center">
                        <h2 class="section__title">Create <span class="yellow-bg yellow-bg-big">MCQ<img
                  ...
                  <div class="events__item-inner  align-items-center justify-content-between white-bg">
                     ...
                     <div class="events__content  ">
                        ...
                        <div class="events__meta">
                            <form action="https://chillwithpill.com/medeval/admin/MK_MCQ_test" method="post" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="ZgNjELIkgBi2so8Q292lAZnqO2b3yEXWn5Ax2SUi">        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label class="form-label" for="formControlSm">Branch</label>
                        <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="branch_id">
            ...
            <div class="col-md-4">
              ...
              <div class="col-sm-12">
                <table class="table table-responsive">
                    <tr id="dynamicrow" class='trcounter'>
                        <td>Question : <input type="text" class="form-control input-sm" id="question" name="question[]" /></td>
              ...
              <button type="submit" class="e-btn">CREATE MCQ</button>
    ...
    type: "POST",
    url: "/MCQ_test",
    data: { "id": $("#mcq_create").val(), "_token": "{{ csrf_token() }}",},
