         ...
         <div class="row">
            <div class="col-xxl-4 offset-xxl-4">
               <div class="section__title-wrapper mb-60 text-center">
                  <h2 class="section__title">Select <span class="yellow-bg yellow-bg-big">Test<img
                ...
                <span class="background-design"></span>
                  <div class="events__item-inner  align-items-center justify-content-between white-bg">
                     ...
                     <div class="events__content  ">
                        ...
                        <h3 class="events__title">Select</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="input-group">
                               <input type="text" class="form-control" name="mcq" placeholder="MCQ">
                               <span class="input-group-btn">
                                    <button class="btn btn-default add_btn" type="button">Add</button>
                               </span>
                            </div>
                            <br>
                            <div class="input-group">
                               <input type="text" class="form-control" name="short_a" placeholder="Short Answer">
                               <span class="input-group-btn">
                                    <button class="btn btn-default add_btn" type="button">Add</button>
                               </span>
                            </div>
                            ...
                            <br>
                            <div class="input-group">
                               <input type="text" class="form-control" name="Osplist" placeholder="Osplist">
                               <span class="input-group-btn">
                                    <button class="btn btn-default add_btn" type="button">Add</button>
                               </span>
                            </div>
                            <br>
                             <div class="input-group">
                               <input type="text" class="form-control" name="Viva" placeholder="Viva">
                               <span class="input-group-btn">
                                    <button class="btn btn-default add_btn" type="button">Add</button>
                               </span>
                            </div>
