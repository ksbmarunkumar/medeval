...
<body>
   ...
   <section class="events__area pt-115 pb-120 p-relative">
      ...
      <div class="container">
         <div class="row">
            <div class="col-xxl-4 offset-xxl-4">
               <div class="section__title-wrapper mb-60 text-center">
                  <h2 class="section__title">View <span class="yellow-bg yellow-bg-big"><img
               ...
               <div class="events__item mb-10 hover__active">
                  ...
                  <div class="events__item-inner  align-items-center justify-content-between white-bg">
                     ...
                     <div class="events__content  ">
                        ...
                        <h3 class="events__title">1. Para-clinical and Clinical subjects</h3>
                        ...
                        <div class="events__meta">
                           <table>
                              <tr>
                                 <td><span>Test Date</span>
                                 <td style="width:20px;text-align: center;">:</td>
                                 <td><span> 1 December 2022</span></td>
                              </tr>
                              <tr>
                           ...
                           <div class="header__btn view__btn-2 ml-50 d-none d-sm-block text-center" >
                              <a href="{{url('/test_View_details')}}" class="btn12" >View</a>
                              <a href="#" class="btn12" >Add</a>
                           </div>
                        </div>
                     </div>
         ...
         <div class="row">
            <div class="col-xxl-10 offset-xxl-1 col-xl-10 offset-xl-1 col-lg-10 offset-lg-1" style="margin-top:50px">
               <div class="events__item mb-10 hover__active">
                 
                  <div class="events__item-inner  align-items-center justify-content-between white-bg">
                     <div class="events__content">
                        <h3 class="events__title">2. Pre-Clinical Subjects</h3>
                        <span class="line-bga"></span>
                        <div class="events__meta">
                           <table>
                              <tr>
