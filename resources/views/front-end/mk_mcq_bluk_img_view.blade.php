            ...
            <div class="row">
                <h2 class="section__title" style="text-align:center; margin-bottom: 30px;">Create <span
                        class="yellow-bg yellow-bg-big"><img src="{{ asset('assets/img/shape/yellow-bg.png') }}"
                            alt="">MCQ Images</span></h2>
                      
                <form action="{{ route('bulk_img_mcq_upload') }}" method="post" enctype="multipart/form-data"
                    id="form_area">
                    @csrf
                    <label class="form-label" for="formControlDefault">Image Select</label>
                    <input type="file" name="bulk_img_mcq[]" id="bulk_img_mcq" multiple>
            ...
            <table id="img_page" class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="" >
                         <input type="text" value="{{$bulk_imgs->image_path}}" id="Path_img{{$bulk_imgs->id}}" style="display:none;">  <button onclick="path_copy({{$bulk_imgs->id}})"><i class="fa fa-clone"> Copy Path</i></button></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
