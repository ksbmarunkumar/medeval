         ...
         <div class="row">
            <div class="col-xxl-4 offset-xxl-4">
               <div class="section__title-wrapper mb-60 text-center">
                  <h2 class="section__title">View <span class="yellow-bg yellow-bg-big">Opslist<img
                           src="assets/img/shape/yellow-bg.png" alt=""></span></h2>

               </div>
            </div>
         </div>
         @foreach($OspTest as $OspTests)
            <div class="row">
               ...
               <div class="events__item mb-10 hover__active">
                  ...
                  <div class="events__item-inner  align-items-center justify-content-between white-bg">
                     ...
                     <div class="events__content  ">
                        ...
                        <h3 class="events__title">{{$loop->iteration}}. {{$OspTests->test_name}}</h3>
                        ...
                        <div class="events__meta">
                           <table>
                              <tr>
                                 ...
                                 <td><span> {{$OspTests->test_name}}</span></td>
                              </tr>
                              <tr>
                                 <td><span>Marks</span>
                                 <td style="width:20px;text-align: center;">:</td>
                                 <td><span> {{$OspTests->marks}}</span></td>
                              </tr>
                              <tr>
                                 <td><span>Duation</span>
                                 <td style="width:20px;text-align: center;">:</td>
                                 <td><span> {{$OspTests->duration}}</span></td>
                              </tr>
                              <tr>
                                 <td><span>No. Of Question</span>
                                 <td style="width:20px;text-align: center;">:</td>
                                 <td><span> {{$OspTests->no_of_que}}</span></td>
                              </tr>
                                    <?php  $subject = DB::table('subjects')->where('id',$OspTests->subject_id)->value('subject') ; ?>
                                    <?php $branch_name = DB::table('branches')->where('id',$OspTests->branch_id)->value('branch_name');
                           ...
                           <div class="header__btn view__btn-2 ml-50 d-none d-sm-block text-center" >
                              <a href="Opslist_View_details/{{$OspTests->id}}" class="btn12" >View</a>
                           </div>
                        </div>
                     </div>
