                          ...
                          <nav id="mobile-menu" style="display: block;">
                              <ul>
                                <li class="has-dropdown">
								  ...
								  <li class="has-dropdown">
                                    <a href="index.html">Short Answer</a>
                                    <ul class="submenu">
                                       <li><a href="#">View</a></li>
                                       <li><a href="#">Assign</a></li>
                                       <li><a href="#">Create</a></li>
                                 ...
                                 <li><a href="#">My Session</a></li>
                              </ul>
                           </nav>
                        </div>
                        <div class="header__btn header__btn-2 ml-50 d-none d-sm-block">
                           <a href="login.html" class="e-btn"><i class="fa fa-sign-in" aria-hidden="true"></i> LogOut</a>
                        </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-xxl-4 offset-xxl-4">
                     <div class="section__title-wrapper mb-60 text-center">
                        <h2 class="section__title">Bulk  <span class="yellow-bg yellow-bg-big">Upload<img src="assets/img/shape/yellow-bg.png" alt=""></span></h2>
               ...
               <div class="row">
                  <div class="col-xxl-10 offset-xxl-1 col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
						  <div class="events__content event_b">
                              <h3 class="events__title answer_details">1.Digital transformation conference</h3>
							  <br>
							  <div class="events__meta">
									...
									<div class="col-md-4 margin-bottom">
									  <input id="textinput" name="textinput" type="text" placeholder="Enter option" class="form-control input-md add_input">
									...
									<button id="add" class="btn add-more button-yellow uppercase feild_btn" type="button">+ Add Option</button> <button class="delete btn button-white uppercase feild_btn">- Remove Option</button>							  
									
							 </div>
							  <br>
							  
							  
							  <h3 class="events__title answer_details">Image Upload</h3>
							   <div class="events__meta">
                                 ...
                                 <div class="text-center">
								  ...
								  <strong>Right answer = A</strong>
                              </div>
							  
							  <a href="#" class="e-btn">Next 5/10</a>
                           </div>
                     </div>
                  </div>
     ...
     <!-- cta area start -->
	  ...
	  <script>
		  ...
		  $("#add").click(function(e) {
			...
			$("#items").append(
			  '<div class="next-referral col-4"><input id="textinput" name="textinput" type="text" placeholder="Enter option" class="form-control input-md addIn"></div>'
			);
		  });
