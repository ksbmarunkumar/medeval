                     ...
                     <div class="events__item mb-10 hover__active">
                        <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                           <div class="events__content">
                              ...
                              <h3 class="events__title"><a href="{{url('/test_report_details')}}">1.Digital transformation conference</a></h3>
                     ...
                     <div class="events__item mb-10 hover__active">
                        <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                           <div class="events__content">
                              ...
                              <h3 class="events__title"><a href="#">2.Digital transformation conference</a></h3>
							   <div class="events__meta">
                                 <span>Jun 14, 2022</span>
								 <br>
                                 <span>Total Marks : 50/100</span>
                     ...
                     <div class="events__item mb-10 hover__active">
                        <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                           <div class="events__content">
                              ...
                              <h3 class="events__title"><a href="#">3.Digital transformation conference</a></h3>
							   <div class="events__meta">
                                 <span>Jun 14, 2022</span>
								 <br>
                                 <span>Total Marks : 50/100</span>
