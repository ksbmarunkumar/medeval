...
<body>
    ...
    <section class="events__area pt-115 pb-120 p-relative">
        ...
        <div class="container">
            <div class="row">
                <h2 class="section__title" style="text-align:center; margin-bottom: 30px;">View
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter test name" value="{{ $test->test_name }} " readonly
                                    class="form-control" name="test_name">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter duration" value="{{ $test->duration }}" readonly
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" placeholder="Enter no of question"
                                    value="{{ $test->date }}" class="form-control" name="no_of_que" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="events__content  ">
                                                                    ...
                                                                    <div class="events__meta">
                                                                        ...
                                                                        <a href="{{ url('MCQ_View_details',$mcqt->mcqt_id) }}" ><button
                                                                                type="button"
                                                            ...
                                                            <div class="events__item-inner  align-items-center justify-content-between white-bg">
                                                                <div class="events__content  ">
                                                                    ...
                                                                    <div class="events__meta">
                                                                        ...
                                                                        <a href="{{ url('Opslist_View_details',$osp->ospt_id) }}"><button
                                                                                type="button"
                                                                                class="btn btn-warning"><i
                                                                                    class="fa fa-eye"
                                                                                    aria-hidden="true"></i>View</button></a>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="Test Name" name="Viva__name"
                                                                id="Viva__name" value="{{$test->viva_name}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="pwd">Total Marks</label>
                                                            <input type="text" class="form-control" value="{{$test->viva_marks}}"
                                                                placeholder="Total Marks" name="Total Marks"
                                                                id="Total Marks">
                                                        </div>
                                                    </div>
                                                </div>
                                                    @foreach($viva_id_topic as $viva_id_topic)
                                                    <div class="events__item mb-10 hover__active">
                                                        <div class="events__item-inner  align-items-center justify-content-between white-bg">
                                                            <div class="events__content  ">
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td> <h3 class="events__title">Topic</h3>
                                                                    </td>
                                                                    <td
                                                                        style="width:20px;text-align: center;">
                                                                        :</td>
                                                                    <td><h3 class="events__title">{{ $viva_id_topic->topic }}</h3>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
