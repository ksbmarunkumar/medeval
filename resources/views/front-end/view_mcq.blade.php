         ...
         <div class="row">
            <div class="col-xxl-4 offset-xxl-4">
               <div class="section__title-wrapper mb-60 text-center">
                  <h2 class="section__title">View <span class="yellow-bg yellow-bg-big">MCQ<img
                           src="assets/img/shape/yellow-bg.png" alt=""></span></h2>

               </div>
            </div>
         </div>
         @foreach($McqTest as $McqTest)
             <div class="row">
                <div class="col-xxl-10 offset-xxl-1 col-xl-10 offset-xl-1 col-lg-10 offset-lg-1">
                   <div class="events__item mb-10 hover__active">
                      <div class="events__item-inner  align-items-center justify-content-between white-bg">
                         <div class="events__content  ">
                                <h3 class="events__title">{{$loop->iteration}}. {{$McqTest->test_name}}</h3>
                                ...
                                <div class="events__meta">
                                   <table>
                                        <tr>
                                         ...
                                         <td><span> {{$McqTest->test_name}}</span></td>
                                      </tr>
                                       <tr>
                                         <td><span>Total Marks</span>
                                         <td style="width:20px;text-align: center;">:</td>
                                         <td><span> {{$McqTest->marks}}</span></td>
                                      </tr>
                                       <tr>
                                         <td><span>Duation</span>
                                         <td style="width:20px;text-align: center;">:</td>
                                         <td><span> {{$McqTest->duration}}</span></td>
                                      </tr>
                                      <tr>
                                         <td><span>No of Question</span>
                                         <td style="width:20px;text-align: center;">:</td>
                                         <td><span> {{$McqTest->no_of_que}}</span></td>
                                      </tr>
                                      <?php //$subject = DB::table('subjects')->where('id',$McqTest->subject_id)->first() ; ?>
                                      <?php //$branch = DB::table('branches')->where('id',$McqTest->branch_id)->first() ; ?>
                                       
                                     <tr>
                                         <td><span>Branch</span>
                                         <td style="width:20px;text-align: center;">:</td>
                                         <td><span> {{$McqTest->branch_name}}</span></td>
                                      </tr>
                                     <tr>
                                         <td><span>Subject Name</span>
                                         <td style="width:20px;text-align: center;">:</td>
                                         <td><span> {{$McqTest->subject}}</span></td>
                                      </tr>
        
                                   </table>
                                   <div class="header__btn view__btn-2 ml-50 d-none d-sm-block text-center" >
                                      <a href="MCQ_View_details/{{$McqTest->test_id}}" class="btn12" >View</a>
                                   </div>
                                </div>
                         </div>
