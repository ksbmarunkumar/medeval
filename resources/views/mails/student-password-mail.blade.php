                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <h1
                                                                style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 22px; ">
                                                                <strong>😀 Hi {{$data['stu_name']}}</strong>
                                                            </h1>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="line-height: 140%;">You have been assigned a
                                                                    test (Test ID - <strong>{{$data['test_id']}}</strong>) ,
                                                                    schedule  on 27 April 2023 , Your Password for
                                                                    Attending this test is -
                                                                    <strong>{{$data['test_password']}}</strong>
                                                                </p>
                                                            </div>
