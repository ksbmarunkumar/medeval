...
<div class="content-wrapper">
    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="forms-sample" method="POST" action="{{ route('create-semester') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="semester_name">Semester<span class="text-red">*</span></label>
                                <input id="semester_name" type="text" class="form-control @error('semester_name') is-invalid @enderror" name="semester_name" value="" placeholder="Enter semester">
