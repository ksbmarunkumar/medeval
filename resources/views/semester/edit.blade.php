...
<div class="content-wrapper">
    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="forms-sample" method="POST" action="{{ url('semester/update') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{$semester->id}}">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="semester_name">Semester<span class="text-red">*</span></label>
                                <input id="semester_name" type="text" class="form-control @error('semester_name') is-invalid @enderror" name="semester_name" value="{{$semester->semester_name}}" placeholder="Enter semester">
                                <div class="help-block with-errors" ></div>
                                @error('semester_name')
                                    <span class="invalid-semester_name" role="alert">
