...
<div class="content-wrapper">
    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="forms-sample" method="POST" action="{{ route('create-student') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="name">Name<span class="text-red">*</span></label>
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="" placeholder="Enter Student Name">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="mobile">Mobile<span class="text-red">*</span></label>
                                <input id="mobile" type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="" placeholder="Enter Student Mobile">
                                <div class="help-block with-errors" ></div>
                                @error('mobile')
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="email">Email<span class="text-red">*</span></label>
                                <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="" placeholder="Enter Student Email">
                                <div class="help-block with-errors" ></div>
                                @error('email')
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="univercity_id">Univercity Id</label>
                                <input id="univercity_id" type="text" class="form-control @error('univercity_id') is-invalid @enderror" name="univercity_id" value="" placeholder="Enter Univercity ID">
                                <div class="help-block with-errors" ></div>
                                @error('univercity_id')
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="admission_no">Admission No<span class="text-red">*</span></label>
                                <input id="admission_no" type="text" class="form-control @error('univercity_id') is-invalid @enderror" name="admission_no" value="" placeholder="Enter Admission No">
                                <div class="help-block with-errors" ></div>
                                @error('admission_no')
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="year_of_joining">Year of joining<span class="text-red">*</span></label>
                                <input id="year_of_joining" type="date" class="form-control @error('univercity_id') is-invalid @enderror" name="year_of_joining" value="">
                                <div class="help-block with-errors" ></div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="section">Section</label>
                                <input id="section" type="text" class="form-control @error('section') is-invalid @enderror" name="section" value="" placeholder="Enter Section Name">
                                <div class="help-block with-errors" ></div>
                                @error('section')
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="Status_student_id"  required>
