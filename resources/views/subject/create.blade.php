...
<div class="content-wrapper">
    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="forms-sample" method="POST" action="{{ route('create-subject') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="subject">Subject<span class="text-red">*</span></label>
                                <input id="subject" type="text" class="form-control @error('subject') is-invalid @enderror" name="subject" value="" placeholder="Enter Subject">
